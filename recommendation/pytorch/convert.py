...
def parse_args():
    ...
    parser.add_argument('--valid-negative', type=int, default=10,
...
def main():
    ...
    train_ratings = torch.tensor([[0,  0,  1,  1,  1,  2,  2,  2,  3,  3],
                                  [3, 10, 10,  2, 11, 15, 14,  8,  4, 13]])
    train_ratings = torch.t(train_ratings)
    nb_users = 4
    nb_items = 16
    test_chunk_size = [4]
